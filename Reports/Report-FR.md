...
* Sauvegarder hors-ligne les données et les applications critiques 
  ...
  * Avoir au moins un niveau de sauvegardes déconnecté du SI, dont l’index des données archivé également accessible hors ligne.
...
* Sanctuariser les activités et services critiques pour l’entité
  ...
  * S'assurer que les logiciels sont à jour et potentiellement accélérer le déploiement des correctifs ou la correction des vulnérabilités identifiées.
...
* S’assurer de l’existence d’un dispositif de gestion de crise adapté à une cyberattaque
  ...
  * S’assurer d’avoir l’ensemble des informations utiles en version papier ou accessible hors réseau de l’entreprise.
...
**Ransomware**
* HermeticRansom : un ransomware opéré en même temps que HermeticWiper.

**Worm**
* HermeticWizard: un worm se propageant dans les réseaux locaux via SMB et WMI utilisé pour déposer HermeticWiper.
...
* https://www.cert.ssi.gouv.fr/uploads/CERTFR-2021-CTI-010.pdf
